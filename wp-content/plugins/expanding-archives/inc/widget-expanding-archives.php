		...
		foreach ( $months as $month ) {
			...
			<li>
				<a href="<?php echo esc_url( get_month_link( $month->year, date( "m", mktime( 0, 0, 0, $month->month, 1, $month->year ) ) ) ); ?>" data-month="<?php echo date( "m", mktime( 0, 0, 0, $month->month, 1, $month->year ) ); ?>" data-year="<?php echo $month->year; ?>" class="clear expanding-archives-clickable-month <?php echo ( $month->year == $date_current_year && date( "m", mktime( 0, 0, 0, $month->month, 1, $month->year ) ) == $date_current_month ) ? 'expandable-archive-rendered-true' : ''; ?>">
                    ...
                    <?php echo ( $month->year == $date_current_year && date( "m", mktime( 0, 0, 0, $month->month, 1, $month->year ) ) == $date_current_month ) ? '' : ''; ?></span> <?php echo date_i18n( "F", mktime( 0, 0, 0, $month->month, 1, $month->year ) ) ?>
                    </span>
