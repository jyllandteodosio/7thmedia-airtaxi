...
class acf_field_google_map_extended_v4 extends acf_field_google_map_extended {
  ...
  */
  function input_admin_enqueue_scripts() {
    wp_register_script("googlemaps-api", "//maps.googleapis.com/maps/api/js?key=AIzaSyDVwnNpcIWP1hUr4mGUsCL1tHo12FLFOOs&v=3&sensor=false&libraries=places",array(),'3',false);
