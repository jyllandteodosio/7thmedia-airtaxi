...
<section id="<?php echo get_field('fleet_section_id'); ?>" class="home-fleet home-section section" style="background-color: <?php echo get_field('fleet_section_background_color'); ?>');">

<?php else: ?>

<section id="<?php echo get_field('fleet_section_id'); ?>" class="home-fleet home-section section" style="background-image: url('<?php echo get_field('fleet_section_background_image'); ?>');">
