...
<section class="home-membership home-section" style="background: <?php echo get_field('membership_section_background_color'); ?>');">

<?php else: ?>

<section class="home-membership home-section" style="background: url('<?php echo get_field('membership_section_background_image'); ?>');">
