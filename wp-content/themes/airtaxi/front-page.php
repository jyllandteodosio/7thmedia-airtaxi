...
function parallax_homepage_widgets() {
	...
	genesis_widget_area( 'home-section-0', array(
		'before' => '<div id="home-section-0" class="home-odd home-section-0 widget-area section fp-auto-height"><div class="wrap">',
		'after'  => '</div></div>',
	) );

	genesis_widget_area( 'home-section-1', array(
		'before' => '<div id="home-section-1" class="home-even home-section-1 widget-area section fp-auto-height"><div class="wrap">',
		'after'  => '</div></div>',
	) );

	genesis_widget_area( 'home-section-2', array(
		'before' => '<div id="home-section-2" class="home-odd home-section-2 widget-area section fp-auto-height"><div class="wrap">',
		'after'  => '</div></div>',
	) );

	genesis_widget_area( 'home-section-3', array(
		'before' => '<div id="home-section-3" class="home-even home-section-3 widget-area section fp-auto-height"><div class="wrap">',
		'after'  => '</div></div>',
	) );
    ...
    genesis_widget_area( 'home-section-5', array(
		'before' => '<div id="home-section-5" class="home-even home-section-5 widget-area section fp-auto-height"><div class="wrap">',
		'after'  => '</div></div>',
	) );
