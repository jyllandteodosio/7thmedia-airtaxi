...
function kickstart_fonts_scripts() {
	wp_enqueue_style( 'cosmos', get_stylesheet_directory_uri() . '/css/app.css' );
	...
	wp_enqueue_script( 'swiper-api', get_stylesheet_directory_uri() . '/js/swiper.min.js' );
	wp_enqueue_script( 'center-image', get_stylesheet_directory_uri() . '/js/jquery.blImageCenter.js' );
...
//    What you need
	...
	wp_enqueue_script( 'cosmos-swiper', get_stylesheet_directory_uri() . '/js/custom/swiper.js' );
	wp_enqueue_script( 'cosmos-main', get_stylesheet_directory_uri() . '/js/custom/main.js' );
...
add_action( 'genesis_footer', 'cosmos_footer' );
function cosmos_footer() {
    get_template_part('section_footer');
}



//To remove Edit Link on Pages and single posts
