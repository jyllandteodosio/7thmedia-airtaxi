	...
	echo genesis_html5() ? '<article class="entry">' : '<div class="post hentry">';
		...
		echo '<div class="entry-content">';
			...
			if ( genesis_html5() ) :
				...
				echo apply_filters( 'genesis_404_entry_content', '<p>' . sprintf( __( 'The page you are looking for no longer exists. <br/>Perhaps you can return back to the site\'s <a href="%s">homepage</a> and see if you can find what you are looking for. <br/>Or, you can try finding it by using the search form below.', 'genesis' ), trailingslashit( home_url() ) ) . '</p>' );
